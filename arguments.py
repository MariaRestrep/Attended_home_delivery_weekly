...
def argument_parser():
    ...
    parser.add_argument('-minsl', type = int, default=4,  help="provide min sl")
    parser.add_argument('-maxsl', type = int, default=10,  help="provide max sl")
    parser.add_argument('-mintl', type = int, default=32,  help="provide min tl")
    parser.add_argument('-maxtl', type = int, default=40,  help="provide max tl")
    parser.add_argument('-shiftgap', type = int, default=1,  help="provide shift gap")
